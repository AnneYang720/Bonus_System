...
class BonusDetailModel(db.Model):
    __tablename__ = 'bonus_detail'
    ...
    amount_b = db.Column(db.DECIMAL(10,2), nullable=True)
    amount_zhan = db.Column(db.DECIMAL(10,2), default=0.0)
    amount_buzhan = db.Column(db.DECIMAL(10,2), default=0.0)
    # isFilled = db.Column(db.Boolean, nullable=False) # 0-no, 1-yes

    def __init__(self, planId, projectId, projectType, amount):
        self.planId = planId
