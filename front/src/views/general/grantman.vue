...
export default {
    ...
    methods: {
        ...
        fetchProjectList(){
            generalApi.getCurProjectList().then(response =>{
        ...
        handleShowDetail(){
            ...
            detailApi.getManProjectDetailList(this.curChosenPlan).then(response =>{
        ...
        beforeAdd(){
            ...
            if(this.newProDetailForm.amountb==''){
                this.$message.error('请填写金额')
                return false
            }
            return true
        ...
        handleAdd(){
            this.$confirm('确认新增项目奖金分配', '提示', {
                ...
                if(this.beforeAdd()){
                    ...
                    detailApi.createManDetail(this.newProDetailForm).then(async(response) => {
        ...
        handleChange(){
            this.$confirm('确认修改项目奖金金额', '提示', {
                ...
                if(this.changeProDetailForm.amount=='' || this.changeProDetailForm.amountb=='' || this.changeProDetailForm.amountb==null){
                    this.$message.error('请填写金额')
                    return false
                }
        ...
        openChange(row){
          ...
          this.changeProDetailForm.amountb = row.amountb
        },
        ...
        getTotal(param) {
            ...
            columns.forEach((column, index) => {
                ...
                if (column.property === 'amount' || column.property === 'amountb' || column.property === 'amount_zhan' || column.property === 'amount_buzhan') {
